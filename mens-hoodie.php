...
<head>
    ...
    <title>Clothing Store - Men's Hoodie</title>
    <style>
        body {
    ...
    <main>
        <div class="product-detail">
            <div class="product-image">
                <img src="images/men_hoodie.jpeg" alt="Men's Hoodie">
            </div>
            <div class="product-info">
                <h2>Men's Hoodie</h2>
                <p><strong>Description:</strong> Warm hoodie suitable for casual outings. Cozy fleece material with a hood, perfect for cooler weather. Stylish and versatile for everyday wear.</p>
                <p><strong>Price:</strong> RM69.99</p>

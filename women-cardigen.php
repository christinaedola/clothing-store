...
<head>
    ...
    <title>Clothing Store - Women's Cardigan</title> 
    <style>
        body {
    ...
    <main>
        <div class="product-detail">
            <div class="product-image">
                <img src="images/women_cardigen.jpeg" alt="Women's Cardigan">
            </div>
            <div class="product-info">
                <h2>Women's Cardigan</h2>
                <p><strong>Description:</strong>Cozy cardigan for women. Soft knit fabric perfect for layering, with a comfortable fit and versatile style for casual or semi-formal occasions.</p> <!-- Updated description to match cardigan -->
                <p><strong>Price:</strong> RM27.99</p>

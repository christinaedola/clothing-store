...
<head>
    ...
    <title>Clothing Store - Men's Polo Shirt</title>
    <style>
        body {
    ...
    <main>
        <div class="product-detail">
            <div class="product-image">
                <img src="images/men_polo.jpeg" alt="Men's Polo Shirt">
            </div>
            <div class="product-info">
                <h2>Men's Polo Shirt</h2>
                <p><strong>Description:</strong> Classic polo shirt for men. Comfortable fabric with a relaxed fit, ideal for casual outings. Stylish and versatile.</p>

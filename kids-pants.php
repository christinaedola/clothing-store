...
<head>
    ...
    <title>Clothing Store - Kids' Pants</title>
    <style>
        body {
    ...
    <main>
        <div class="product-detail">
            ...
            <div class="product-info">
                <h2>Kids' Pants</h2>
                <p><strong>Description:</strong> Comfortable shorts for active kids. Lightweight and durable fabric ideal for play, sports, or casual wear. Designed for comfort and ease of movement.</p>

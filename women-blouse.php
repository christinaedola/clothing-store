...
<head>
    ...
    <title>Clothing Store - Women's Blouse</title>
    <style>
        body {
    ...
    <main>
        <div class="product-detail">
            <div class="product-image">
                <img src="images/women_blouse.jpeg" alt="Women's Blouse">
            </div>
            <div class="product-info">
                <h2>Women's Blouse</h2>
                <p><strong>Description:</strong> Casual blouse perfect for everyday style. Soft, breathable fabric with a comfortable fit, ideal for work, outings, or layering.</p>
                <p><strong>Price:</strong> RM24.99</p>

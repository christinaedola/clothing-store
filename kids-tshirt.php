...
<head>
    ...
    <title>Clothing Store - Kids' T-Shirt</title>
    <style>
        body {
    ...
    <main>
        <div class="product-detail">
            ...
            <div class="product-info">
                <h2>Kids' T-Shirt</h2>
                <p><strong>Description:</strong> Soft cotton t-shirt for kids. Made from gentle, breathable fabric perfect for playtime and everyday comfort. Available in fun colors and sizes for growing kids.</p>
                <p><strong>Price:</strong> RM14.99</p>
                ...
                <br>
                <a href="kids.php" style="color: black;">Back to Kids' Clothing</a>
            </div>
        </div>
    </main>
</body>
